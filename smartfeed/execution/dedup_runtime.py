...
class DedupRuntime:
    ...
    def _compute_quota_deficits(self, *, plan: SlotsPlan, owner_buffers: Dict[int, List[Any]]) -> Dict[int, int]:
    ...
    def _compute_fill_deficits(self, *, plan: SlotsPlan, remaining: int, deficit_slots: List[int]) -> Dict[int, int]:
